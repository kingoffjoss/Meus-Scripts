(function() {
    ...
    lS("compatibility.js")
        ...
        .then(()=>{
            console.log("✅ Sistema V25 Carregado (ScriptGenesys)!");
            // Aviso Visual
            let d=document.createElement("div");d.style.cssText="position:fixed;top:10px;left:50%;transform:translateX(-50%);background:#2ecc71;color:#fff;padding:8px 15px;border-radius:20px;z-index:99999;font-weight:bold;font-family:sans-serif;box-shadow:0 5px 15px rgba(0,0,0,0.3)";
            d.innerText="🚀 Sistema Genesys Ativo";document.body.appendChild(d);setTimeout(()=>d.remove(),3000);
        })
